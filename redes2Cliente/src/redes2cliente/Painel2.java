...
public class Painel2 extends javax.swing.JPanel {
    ...
    public void ligar() {
        try {
            Janela.srvAddr = InetAddress.getByName(Janela.ip);
            sock = new Socket(Janela.srvAddr, Janela.porta);
    ...
    public void enviar(String comando, String argumento, String hash)  {
        ...
        try {
            ...
            Socket sock = new Socket(Janela.srvAddr, Janela.porta);
