...
public class Painel2 extends javax.swing.JPanel {
    ...
    public void ligatThreadRecebimento() {
        thread1 = new Thread(JanelaWhatsapp.recebedor);
        thread1.start();
    }
    ...
    public void enviarMensagem(String messagemFormatada) throws IOException {
        ...
        DatagramPacket pacoteEnvio = new DatagramPacket(jsonBytes, jsonBytes.length, group, JanelaWhatsapp.porta);
    ...
    public String converterJson(String mensagem) {
        ...
        jsonMessage.put("username", JanelaWhatsapp.user);
    ...
    public void entrarGrupoMulticast() {
        try {
            socket = new MulticastSocket(JanelaWhatsapp.porta);
            
            group = InetAddress.getByName(JanelaWhatsapp.ip);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            Logger.getLogger(JanelaWhatsapp.class.getName()).log(Level.SEVERE, null, ex);
        }
