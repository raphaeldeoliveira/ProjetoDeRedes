...
public class Painel1 extends javax.swing.JPanel {
    ...
    public void enviar2(String comando, String argumento, String digital) {
        ...
        try {
            srvIPAddr = InetAddress.getByName(JanelaEnergia.ip);
        }
        catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            DatagramPacket txPkt = new DatagramPacket(txData, txMsg.length(), srvIPAddr, JanelaEnergia.porta);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        janela.getContentPane().remove(JanelaEnergia.p1);
        janela.add(JanelaEnergia.p2, BorderLayout.CENTER);
        janela.pack();
